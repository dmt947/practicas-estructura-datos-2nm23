...
int main(){
    ...
    if(TV == 1){
        ...
        IOrdenador<int>* ord = new Merge<int>(); // POLIMORFISMO
        ...
        IOrdenador<float>* ord = new Merge<float>();
        ...
        IOrdenador<string>* ord = new Merge<string>();
        ...
        IOrdenador<persona>* ord = new Merge<persona>();
