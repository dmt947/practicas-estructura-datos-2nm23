...
int main(){
    ...
    if(TV == 1){
        ...
        IOrdenador<int>* ord = new Burbuja<int>(); // POLIMORFISMO
        ...
        IOrdenador<float>* ord = new Burbuja<float>();
        ...
        IOrdenador<string>* ord = new Burbuja<string>();
        ...
        IOrdenador<persona>* ord = new Burbuja<persona>();
